package com.thosijulio.currencyview
...
class MainActivityTest {
    ...
    fun test_req_7_criar_classes_que_representam_as_respostas_dos_endpoints_get_symbols_e_latest() {
        try {
            // Existe a data class CurrencySymbolResponse no pacote com.thosijulio.currencyview.data.models?
            val currencySymbolResponseClassName =
                "com.thosijulio.currencyview.data.models.CurrencySymbolResponse"
        ...
        try {
            // Existe a data class CurrencyRateResponse no pacote com.thosijulio.currencyview.data.models?
            val currencyRateResponseClassName =
                "com.thosijulio.currencyview.data.models.CurrencyRateResponse"
